...
export const Footer = () => {
  return (
    <footer>
        ...
        <h5 className='contact-icon'>E-mail <img src={mailIcon} alt="email" /><Link href="mailto:felicitas.aguerrald@gmail.com" target="_blank" rel="noopener noreferrer" class="tooltip"></Link></h5>
